...
Deck status: PPTX generated at [ASEM-Talint-10-minute-presentation.pptx](./ASEM-Talint-10-minute-presentation.pptx).  
Target runtime: 10 minutes  
Intended output: speaker notes and slide-copy source for the generated deck and later revisions

Current implementation note: the exported deck is generated by [generate_pitch_deck.py](./generate_pitch_deck.py) and already embeds live ASEM Talint snapshots from the current local build.
